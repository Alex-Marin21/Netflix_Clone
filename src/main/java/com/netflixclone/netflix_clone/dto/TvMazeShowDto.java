...
public class TvMazeShowDto {
    ...
    @JsonProperty("summary") // Descrierea
    private String summary;

    @JsonProperty("premiered") // Data lansarii
    private String premiered;

    @JsonProperty("rating")
    private RatingDto rating; // Obiect imbricat
    ...
    public TvMazeImageDto getImage() { return image; }
    public void setImage(TvMazeImageDto image) { this.image = image; }
